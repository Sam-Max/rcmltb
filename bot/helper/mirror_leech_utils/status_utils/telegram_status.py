...
from bot.helper.mirror_leech_utils.status_utils.status_utils import get_bottom_status, humanbytes, time_formatter
...
class TelegramStatus:
     ...
     async def progress(self, current, total, name, status, current_time):
         ...
         if round(diff % 10.00) == 0 or current == total:
            ...
            try:
                  await editMarkup(self._status_msg, self._message, 
